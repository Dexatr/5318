// make clean_1HzAlternative && make 1HzAlternative && sudo truncate -s 0 /var/log/syslog && ./1HzAlternative && uname -a > 1hz_alternative_syslog.txt && sudo grep -F "[1Hz]" /var/log/syslog >> 1hz_alternative_syslog.txt
...
#define CAPTURE_FRAMES (1817 + LAST_FRAMES) // Total frames for 1Hz capture (1817 seconds + 1 last frame)
